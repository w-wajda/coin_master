...
from app.domain.email_templates.email_schemas import UpdateEmailTemplateSchema
...
class UpdateEmailTemplateCommand:
    ...
    async def __call__(self, uuid: UUID, email_template_data: UpdateEmailTemplateSchema) -> EmailTemplate:
